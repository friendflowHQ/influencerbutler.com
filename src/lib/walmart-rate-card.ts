...
// Bump when the rates below change, so the ETag changes and clients refetch.
...
const ROWS: RateCardRow[] = [
  ...
  { label: "Home & Garden", tokens: ["home", "garden", "furniture", "patio", "kitchen", "dining"], ratePct: 4 },
  { label: "Beauty", tokens: ["beauty", "cosmetics", "skincare", "makeup"], ratePct: 4 },
  { label: "Health & Wellness", tokens: ["health", "wellness", "personal care"], ratePct: 4 },
  { label: "Baby", tokens: ["baby", "toddler", "infant"], ratePct: 4 },
  { label: "Toys", tokens: ["toys", "games"], ratePct: 4 },
  { label: "Clothing & Accessories", tokens: ["clothing", "apparel", "shoes", "accessories", "fashion"], ratePct: 4 },
  { label: "Jewelry", tokens: ["jewelry", "watches"], ratePct: 4 },
  { label: "Sports & Outdoors", tokens: ["sports", "outdoors", "fitness", "exercise"], ratePct: 4 },
  { label: "Auto & Tires", tokens: ["auto", "automotive", "tires", "parts"], ratePct: 4 },
  { label: "Pets", tokens: ["pet", "pets"], ratePct: 4 },
  { label: "Grocery & Food", tokens: ["grocery", "food", "beverages", "gourmet"], ratePct: 1 },
  { label: "Household Essentials", tokens: ["household", "cleaning", "paper", "essentials"], ratePct: 1 },
