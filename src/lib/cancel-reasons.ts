...
// that skipped the funnel), and the admin cancellations view. The pure
// constants + normalizers live in cancel-reasons-shared.ts so client
// components can import them without pulling this file's server-only imports
// into the browser bundle; they are re-exported here so server-side callers
// keep a single import point.

import { createAdminClient } from "@/lib/supabase/admin";
import { maskEmail } from "@/lib/mask-email";
import { loadComps, type CompRow, type CompState } from "@/lib/comps-data";
import { reasonLabel } from "@/lib/cancel-reasons-shared";
...
export {
  ...
  reasonLabel,
  normalizeReason,
  normalizeWouldReturn,
  type Reason,
  type ReasonOption,
  type WouldReturn,
  type WouldReturnOption,
