...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  entry("prime-day-butler", "Prime Day Butler: Win Prime Day without the scramble", "Prime Day Butler unlocks July 1–17 and surfaces Prime Day deals you can post about: content you already made, products you already own, and fresh discoveries - with CC/SPCC opportunity flags and one-click handoff to Daily Deals Butler."),
