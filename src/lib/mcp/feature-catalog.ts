...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  entry("api-integrations", "API Integrations: Everything plugs into Butler", "API Integrations connect Influencer Butler to Archer, Levanta, Amazon Creators API, GeniusLink, URLGenius, Linktw.in, and more. Or route links through Influencer Butler's own branded short links and see the clicks in a built-in Link Performance dashboard."),
  ...
  entry("deals-butler", "Deals Butler: Post the best deals faster", "The Deals Butler finds hot deals across Amazon, Walmart, and more that match your filters and lines them up for posting. Deals land in a queue - you post when you're ready."),
  ...
  entry("instagram-like-butler", "Instagram Like Butler: Auto-like Instagram posts the safe way", "Instagram Like Butler likes the recent posts of the Instagram accounts you pick, with per-account caps and safe pacing. Free forever - works on trial, paid, expired, or cancelled."),
  ...
  entry("prime-day-butler", "Prime Day Butler: Win Prime Day without the scramble", "Prime Day Butler unlocks June 10–July 1 and surfaces Prime Day deals you can post about: content you already made, products you already own, and fresh discoveries - with CC/SPCC opportunity flags and one-click handoff to the Deals Butler."),
  entry("pricecrash-butler", "Pricecrash Butler: Catch Amazon pricing errors fast", "Pricecrash Butler scans Amazon on a schedule for products discounted ≥99% off and queues catches in the Deals Butler - as drafts for review or auto-scheduled posts. Threshold is configurable down to 50% for a broader steep-discount radar."),
  ...
  entry("walmart-butler", "Walmart Butler: Research Walmart products and repost your storefront", "Walmart Butler has two tools. Walmart Research tracks price history, approximate rank, estimated monthly sales, and stock for the Walmart products you look up, refreshed daily. Walmart Repost republishes your Amazon storefront videos and photos to your Walmart Creator storefront, hands-free, only on an exact barcode (UPC/GTIN) match."),
...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    cadence: "monthly",
    seats: 3,
    highlights: ["Everything in Pro Solo", "Up to 3 activated devices", "Shared seat pool"],
    signupUrl: `${BASE}/pricing`,
  },
  {
    id: "duo-annual",
    ...
    cadence: "annual",
    seats: 3,
    highlights: ["Everything in Pro Solo", "Up to 3 devices", "Save 17% vs monthly"],
    signupUrl: `${BASE}/pricing`,
  },
  {
    id: "team-monthly",
