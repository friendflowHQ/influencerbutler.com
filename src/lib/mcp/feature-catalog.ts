...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  entry("prime-day-butler", "Prime Day Butler: Win Prime Day without the scramble", "Prime Day Butler unlocks June 10–July 1 and surfaces Prime Day deals you can post about: content you already made, products you already own, and fresh discoveries - with CC/SPCC opportunity flags and one-click handoff to Daily Deals Butler."),
  entry("pricecrash-butler", "Pricecrash Butler: Catch Amazon pricing errors fast", "Pricecrash Butler scans Amazon on a schedule for products discounted ≥99% off and queues catches in Daily Deals Butler - as drafts for review or auto-scheduled posts. Threshold is configurable down to 50% for a broader steep-discount radar."),
...
export const PRICING_TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    cadence: "monthly",
    seats: 1,
    highlights: ["All 29+ butlers unlocked", "1 activated device", "Cancel anytime"],
  ...
  },
  {
    ...
    cadence: "annual",
    seats: 1,
    highlights: ["All 29+ butlers unlocked", "Save 17% vs monthly", "1 activated device"],
