...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  entry("daily-deals-butler", "Deals Influencer Butler: Post the best deals faster", "The Deals Influencer Butler finds hot deals across Amazon, Walmart, and more that match your filters and lines them up for posting. Deals land in a queue - you post when you're ready."),
  ...
  entry("prime-day-butler", "Prime Day Butler: Win Prime Day without the scramble", "Prime Day Butler unlocks June 10–July 1 and surfaces Prime Day deals you can post about: content you already made, products you already own, and fresh discoveries - with CC/SPCC opportunity flags and one-click handoff to the Deals Influencer Butler."),
  entry("pricecrash-butler", "Pricecrash Butler: Catch Amazon pricing errors fast", "Pricecrash Butler scans Amazon on a schedule for products discounted ≥99% off and queues catches in the Deals Influencer Butler - as drafts for review or auto-scheduled posts. Threshold is configurable down to 50% for a broader steep-discount radar."),
