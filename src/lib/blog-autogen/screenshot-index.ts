...
export const STATIC_SCREENSHOTS: ScreenshotEntry[] = [
  ...
  { path: "/assets/features/deals-butler-carousel-1.png", description: "Deals Butler deal feed filtered by price, discount, and commission" },
  { path: "/assets/features/deals-butler-carousel-2.png", description: "Deals Butler post template editor for automated deal posts" },
  { path: "/assets/features/deals-butler-carousel-3.png", description: "Deals Butler social destinations picker (Facebook groups, pages, Telegram)" },
  { path: "/assets/features/deals-butler-carousel-4.png", description: "Deals Butler posting schedule configuration" },
  { path: "/assets/features/deals-butler-carousel-5.png", description: "Deals Butler run history of automatically posted deals" },
