...
const DISMISS_KEY = "ib_likebutler_freebie_dismissed_v1";
const SUNSET_TS = Date.UTC(2026, 6, 26);

export default function LikeButlerFreebieBanner() {
    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            href="/help/tutorials/likebutler"
          ...
          <a
            href="/help/tutorials/benable-like-butler"
