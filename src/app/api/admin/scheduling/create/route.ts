...
export async function POST(request: Request) {
  ...
  // Schedule a recording bot for a real Meet room, exactly like a self-service
  // booking. A manual/absent link has no room to join, so recording is skipped.
  // Best-effort: a failure here never fails the confirmed add.
