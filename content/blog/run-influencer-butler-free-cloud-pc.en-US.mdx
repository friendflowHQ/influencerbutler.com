...
**Is it really free?** Yes, for months. New AWS accounts get free credits (up to $200) plus a free usage window, which comfortably covers your cloud computer while you get going. After the credits run out it is a small monthly cost you control (around $44 for the recommended size, less if you stop it when you are not using it), and the alarm from Step 15 warns you long before anything sneaks up.
