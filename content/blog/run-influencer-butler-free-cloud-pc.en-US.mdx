...
**Prefer to skip the setup? There is a one-click shortcut.** The free AWS steps below are worth it, and this guide walks you through every one. But if fiddling with the AWS console is not your idea of fun, you can rent a ready-made Windows cloud PC in a few minutes from a managed host like [Hostwinds](https://clients.hostwinds.com/aff.php?aff=10402) for a few dollars a month, then skip straight to installing Influencer Butler. There is more on that shortcut at the end. Heads up: that is an affiliate link, so we earn a little if you sign up through it, at no extra cost to you. We only mention it because it genuinely saves you the hassle.
