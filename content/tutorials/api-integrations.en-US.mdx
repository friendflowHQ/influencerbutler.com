...
**Influencer Butler** is also a deeplink provider in its own right. Pick it under **DeepLink Routing** and every link your tools build becomes a branded `links.influencerbutler.com` short link that you own. It is part of a paid plan; on the free trial the option shows "Upgrade to use."
