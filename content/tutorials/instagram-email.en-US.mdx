...
- **Schedule appears stuck**: settings lock during active schedule. Click Stop Schedule, edit, re-apply.
- **Same email under a different name**: each email address is listed once. If a brand messaged you from two accounts, Butler keeps the entry under the handle it resolves and won't duplicate the address.
