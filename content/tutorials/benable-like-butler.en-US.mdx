...
1. Open **Benable Butler** in the left sidebar, then **Benable Like Butler** (nested under the Benable Butler toggle).
...
- **A run finishes instantly and nothing shows in History**: no profile links are saved yet, so there is nothing to visit. Benable Like Butler likes other creators' profiles, not your own lists. Click Stop Schedule, paste creator profile URLs (`https://benable.com/<profile-name>`) under Benable Profile URLs, then Enable Schedule again or click Start Benable Like Butler.
