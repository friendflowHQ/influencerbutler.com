...
- **"Accepted campaigns sync" appears and you don't remember accepting anything**: nothing was accepted for you. That scheduled job is read only. It opens Amazon, reads the Creator Connections campaigns you accepted yourself, and files them so your records stay current. Accepting campaigns on your behalf is a separate butler that only runs when you start it.
